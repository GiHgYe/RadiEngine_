...
public:
    ...
    float v4{ 0.f },  v5{ 1.f },  v6{ 0.f },  v7{ 0.f };
    float v8{ 0.f },  v9{ 0.f },  v10{ 1.f }, v11{ 0.f };
    float v12{ 0.f }, v13{ 0.f }, v14{ 0.f }, v15{ 1.f };
};
...
public:
    ...
    {
        return Matrix4x4(m_mat[0][0], m_mat[1][0], m_mat[2][0], m_mat[3][0],
