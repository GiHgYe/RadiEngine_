...
#define REFLECTION_BODY(class_name) \
    ...
    public: inline static std::string ClassName() { return #class_name; }
...
#define REFLECTION_INFO(class_name) public: \
    virtual inline std::string get_name() const { return #class_name; }
...
#define REFLECTION_DEEP_COPY(type, dst_ptr, src_ptr) *static_cast<type*>(dst_ptr) = *static_cast<type*>(src_ptr.getPtr());
...
#define TypeMetaDefPtr(class_name, ptr) new Reflection::ReflectionInstance(Reflection::TypeMeta::newMetaFromName(#class_name), (class_name*)ptr)
...
namespace Reflection {
    ...
    public:
        ...
        template<class T>
        static TypeMeta newMeta() { return newMetaFromName(T::ClassName()); }
