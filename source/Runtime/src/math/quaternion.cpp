...
Quaternion Quaternion::GetQuaternionFromEulerAngle(const Vector3& euler)
{
    double cy = std::cos(Math::DegreesToRadians(euler.z * 0.5));
    double sy = std::sin(Math::DegreesToRadians(euler.z * 0.5));
    double cp = std::cos(Math::DegreesToRadians(euler.y * 0.5));
    double sp = std::sin(Math::DegreesToRadians(euler.y * 0.5));
    double cr = std::cos(Math::DegreesToRadians(euler.x * 0.5));
    double sr = std::sin(Math::DegreesToRadians(euler.x * 0.5));
